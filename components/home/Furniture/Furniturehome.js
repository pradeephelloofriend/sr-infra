...
function Furniturehome({ funData }) {
                ...
                <div className="container py-md-5">
                    ...
                    <Swiper slidesPerView={3} spaceBetween={30} pagination={{
                       ...
                       {funData.map((i, index) =>
                            ...
                            <a onClick={()=>handleRoute(i.acf.category.name)}>
                            ...
                            <Title level={5} className='mb-5'><a className='swipe-title text-l-black'>{i.acf.category.name}</a></Title>
                                        <div className='mb-5'>
                                            {/* <Text >{i?.acf?.category?.description}</Text> */}
                                        </div>
                                        <a onClick={() => router.push('/furniture')} className='mt-5 text-l-black rm-hover'>Read More <RightOutlined className='arrow-bounce' /></a>
                                    </div>
                                </Card></a>
                            </SwiperSlide>
                        )}
